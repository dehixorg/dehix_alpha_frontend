  ...
  return (
    <div className="container text-center max-w-2xl mx-auto px-4 py-16">
      ...
      <p className="mb-16 mt-6 text-gray-500">
        Our platform connects you with talented freelancers from around the world, empowering you to bring your projects to life. We're dedicated
        to providing a seamless experience and helping you find the perfect fit for your needs.
      </p>
      <div className="flex flex-row justify-center items-center text-cyan-400">
        <div className="rounded-lg bg-[#1a1a1a] p-6 text-left">
          <svg className="h-8 w-8 text-[#00ffff]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
