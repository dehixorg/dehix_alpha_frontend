                ...
                <CardHeader className="px-4 py-3 flex justify-between items-center">
                    <div className="m-6 ">
                        ...
                        <Avatar>
                            ...
                            <AvatarFallback>{title.charAt(0)}{title.split(" ")[1]?.charAt(0)}</AvatarFallback>
                        </Avatar>
                        </div>
                        <div>
                            <CardTitle className="font-bold text-gray-600 text-lg">{title}</CardTitle>
                        </div>
                        <div>
                            <CardDescription className="text-gray-600">{email}</CardDescription>
                        </div>
                        <div>
                            <CardDescription className="text-gray-600">{phoneno}</CardDescription>
                        </div>
                        <div>
                            <a
