            ...
            <div className="p-6 rounded-lg w-full h-auto flex flex-col mt-44 m-64">
                ...
                <div className="w-full">
                    {experiences.map((experience, index) => (
                        <div key={index} className="relative bg-white border rounded-lg p-6 mb-4 shadow-lg w-full">
                            ...
                            <p className="text-gray-900 text-xl font-semibold mb-1">{experience.role}</p>
                            <p className="text-gray-700 mb-1">{experience.companyName}</p>
                            <p className="text-gray-600 mb-1">{format(experience.start, 'PPP')} - {format(experience.end, 'PPP')}</p>
                            {experience.referenceName && <p className="text-gray-600 mb-1">Reference Person Name: {experience.referenceName}</p>}
                            {experience.referenceEmail && <p className="text-gray-600 mb-1">Reference Person Email: {experience.referenceEmail}</p>}
                            {experience.location && <p className="text-gray-600 mb-1">Location: {experience.location}</p>}
                            {experience.description && <p className="text-gray-600">{experience.description}</p>}
                        </div>
                    ))}
                </div>
                ...
                <div className="flex justify-center items-center mt-8">
                    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                        <DialogTrigger asChild>
                            <Button className="bg-gray-600" variant="outline" onClick={toggleDialog}>Add Experience</Button>
                        </DialogTrigger>
                            ...
                            <div className="grid grid-row-4 gap-4 py-4 max-h-[70vh] overflow-y-auto">
                                <Form {...form}>
                                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input placeholder="Enter Reference Person Email" {...field} />
                                                    </FormControl>
                                        ...
                                        <DialogFooter>
                                            <Button type="submit" onClick={toggleDialog}>Save changes</Button>
                                        </DialogFooter>
                                    </form>
                                </Form>
                            </div>
...
>>>>>>> feadf98 (made dynamic work exp popup form and cards for freelancer)
