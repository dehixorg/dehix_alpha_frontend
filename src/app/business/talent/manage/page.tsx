  ...
  React.useEffect(() => {
    ...
    try {
      ...
      if (talentData.freelancers && Array.isArray(talentData.freelancers)) {
        ...
        const formattedFreelancers = talentData.freelancers.map(
          (freelancer) => ({
            _id:
              freelancer._id ||
            ...
            interview_ids: Array.isArray(freelancer.interview_ids)
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-6 w-full">
                {freelancers.map((freelancer) => (
                  ...
                  >
                    ...
                    <CardContent className="p-4 sm:p-5 flex-grow min-w-0 space-y-3">
                      <div className="space-y-2 text-sm">
                        ...
                        {freelancer.cover_letter && (
                          <div className="line-clamp-3 text-gray-600 dark:text-gray-300 text-sm break-words">
                    ...
                    <CardFooter className="flex justify-between items-center p-4 sm:p-5 mt-auto border-t border-gray-100 dark:border-gray-700">
                      <div className="text-sm text-gray-500 dark:text-gray-400">
                        {freelancer.interview_ids?.length || 0} interviews
                      </div>
                      <Button
                        variant="outline"
                        size="sm"
