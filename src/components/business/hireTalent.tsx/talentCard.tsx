      ...
      const fetchUserData = useCallback(async () => {
          try {
            ...
            if (user?.uid) {
              ...
              skillDomainFormProps?.setFilterSkill(fetchedFilterSkills);
              skillDomainFormProps?.setFilterDomain(fetchedFilterDomains);
        ...
        }, [user?.uid, skillDomainFormProps?.setFilterSkill, skillDomainFormProps?.setFilterDomain]);
              ...
              <CardContent>
                <div className="mb-4">
                  ...
                  {SHEET_SIDES.map((View) => (
                    ...
                    <SheetContent side={View} className="overflow-y-auto max-h-[100vh]">
                      <SheetHeader>
                      ...
                      <div className="mt-2">
                        <div className="w-full text-center">
                          <Button className="w-full text-sm py-1 px-2  text-black rounded-md" type='submit'>Save</Button>
                        </div>
                      </div>
                      </div>
