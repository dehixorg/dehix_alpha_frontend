    ...
    try {
      const response = await axiosInstance.post('/business/hire/invite', {
        ...
        freelancer_professional_profile_id:
          selectedTalentForInvite.freelancerProfessionalProfileId,
        hireId,
                    ...
                    <div className="flex items-center justify-between mt-3 gap-2">
                      ...
                      <Button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          window.open(
                            `/business/freelancerProfile/${talent.freelancer_id}`,
                            '_blank',
                          );
                        }}
                      >
