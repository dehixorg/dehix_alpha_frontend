...
function ProjectSkillCard({
  ...
  return (
    <div className="w-[300px] mx-auto relative border border-gray-700 rounded-lg shadow-md p-6 flex flex-col h-full">
    {/* Header */}
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-wrap gap-2">
            {domains.map((domain, index) => (
              <Badge key={index} className="px-3 bg-gray-200 text-gray-900 py-1 text-xs rounded-full">
                {domain}
              </Badge>
            ))}
          </div>
