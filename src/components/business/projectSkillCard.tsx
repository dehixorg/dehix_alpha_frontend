...
function ProjectSkillCard({
  ...
  return (
    <div className="w-[300px] mx-auto  relative  h-[430px] text-white border border-gray-700 rounded-lg shadow-md p-6">
      {/* Header */}
      ...
      <div className="mb-4">
        <Separator />
        <div className="flex mt-6 mb-6 items-center text-sm text-gray-300 ">
        ...
        {/* Email */}
        <div className="flex mt-[28px] items-center text-sm text-gray-300">
          <Mail className="w-4 h-4 mr-2 text-[#fcd062]" />
          <span>{email || 'No email provided.'}</span>
        </div>
      </div>

      {/* Footer */}
      <button className="w-auto absolute bottom-4 bg-blue-600 text-white px-5  py-1 rounded-md hover:bg-blue-700">
        Mark as completed
      </button>
    </div>
  );
