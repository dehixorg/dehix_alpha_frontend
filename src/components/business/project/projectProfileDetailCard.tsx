  ...
  return (
    <Card className={cn("w-[350px]", className)} {...props}>
      <CardHeader>
        ...
        <CardDescription className="text-gray-600">Your requirement is of 2 freelancers for this profile, 6 people have appplied via bid and 1 person is selected till now.</CardDescription>
      </CardHeader>
