...
const countries = [
    { code: 'AF', name: 'Afghanistan', dialCode: '+93', minLength: 9, maxLength: 10 },
    ...
    { code: 'KH', name: 'Cambodia', dialCode: '+855', minLength: 9, maxLength: 10 },
    ...
    { code: 'ID', name: 'Indonesia', dialCode: '+62', minLength: 10, maxLength: 12 },
    ...
    { code: 'KR', name: 'South Korea', dialCode: '+82', minLength: 10, maxLength: 11 },
    { code: 'LA', name: 'Laos', dialCode: '+856', minLength: 9, maxLength: 10 },
    { code: 'MY', name: 'Malaysia', dialCode: '+60', minLength: 9, maxLength: 10 },
    { code: 'MV', name: 'Maldives', dialCode: '+960', minLength: 7, maxLength: 7 },
    { code: 'MX', name: 'Mexico', dialCode: '+52', minLength: 10, maxLength: 10 },
    { code: 'MN', name: 'Mongolia', dialCode: '+976', minLength: 9, maxLength: 10 },
    ...
    { code: 'PK', name: 'Pakistan', dialCode: '+92', minLength: 10, maxLength: 11 },
    ...
    { code: 'CH', name: 'Switzerland', dialCode: '+41', minLength: 9, maxLength: 9 },
    { code: 'TZ', name: 'Tanzania', dialCode: '+255', minLength: 9, maxLength: 10 },
    { code: 'TH', name: 'Thailand', dialCode: '+66', minLength: 9, maxLength: 10 },
