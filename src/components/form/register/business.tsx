...
function getPasswordStrength(password: string) {
  ...
  let label = 'Weak';
  if (level >= 2) { color = 'bg-yellow-400'; label = 'Fair'; }
                        ...
                        <div>
                          ...
                          <div className="flex flex-col gap-2 mt-2">
                            ...
                            <span className={`text-xs font-semibold ${
                              passwordStrength.label === 'Weak' ? 'text-red-500' : passwordStrength.label === 'Fair' ? 'text-yellow-500' : passwordStrength.label === 'Good' ? 'text-blue-500' : 'text-green-600'
