...
const SidebarMenu: React.FC<SidebarMenuProps> = ({
              ...
              className={`flex h-9 w-9 items-center justify-center rounded-lg ${
                item.label === active || item.label === 'Dehix'
                  ? item.label === 'Dehix'
                    ...
                    : 'flex h-9 w-9 items-center justify-center rounded-lg bg-accent text-accent-foreground transition-colors hover:text-foreground md:h-8 md-w-8 dark:hover:bg-[#27272a]'
                  : 'flex h-9 w-9 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:text-foreground md:h-8 md-w-8 dark:hover:bg-[#27272a]'
              }`}
            >
              {item.icon}
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-10 hidden w-14 flex-col border-r bg-background dark:bg-[#09090b] sm:flex">
