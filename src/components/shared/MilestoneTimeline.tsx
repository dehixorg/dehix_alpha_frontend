...
const dummyMilestones = [
  {
    ...
    description: 'Initial development phase began, setting the foundation for the project.'
  },
  {
    date: 'Jun 14, 2018',
    title: 'Pre-ICO Opens',
    description: 'The Pre-ICO phase was launched to gather early investments for the project.'
  },
  {
    date: 'Jul 24, 2018',
    title: 'Private Token Round',
    description: 'Private investors were invited to participate in the token sale.'
  },
  {
    date: 'Sep 14, 2018',
    title: 'Pre-ICO Closed',
    description: 'The Pre-ICO phase was successfully concluded, raising the required funds.'
  },
  {
    date: 'Dec 24, 2018',
    title: 'Decentralized Platform Launch',
    description: 'The decentralized platform was officially launched, marking a major milestone.'
  },
  {
    date: 'Jan 15, 2019',
    title: 'App Integration Process',
    description: 'Efforts began to integrate the application with the decentralized platform.'
  }
];
        ...
        {[...dummyMilestones, ...dummyMilestones].map((milestone, index) => {
          ...
          return (
            ...
            >
              ...
              >
                <div
                  className={`absolute left-1/2 transform -translate-x-1/2 ${index % 2 === 0 ? 'top-[-15px]' : ''
                    } text-white `}
                >
                  |
                </div>
