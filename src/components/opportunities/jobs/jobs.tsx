...
const Jobs: React.FC<JobsProps> = ({ heading, icon: IconComponent, content, skills, location, founded, employees }) => {
    return (
        <Card className="w-auto">
            <CardContent>
                <div >
                    <div className="flex-1">
                        <div className="text-white text-lg font-medium items-center mt-4">{heading}</div>
                        <CardDescription>
                            <div className="flex">
                            ...
                            <div className="flex">
                                ...
                                <p className="ml-2">{founded} . {employees}</p>
                            </div>
                        </CardDescription>
                    ...
                    <div className="flex">
                        ...
                        <div className="ml-5 mt-3">
                            <p className="cursor-pointer text-gray-500 hover:underline">Not interested</p>
                        </div>
                    </div>
                </div>
            </CardContent>
