    ...
    <div>
      <Card className="">
        <CardHeader className="pb-3">
          <CardTitle>{dummyData.projectCompleteCard.companyName}</CardTitle>
          <CardDescription className="">
            <div className="mt-4 grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8 lg:grid-cols-4 xl:grid-cols-4">
              <div className="grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-3 border-r-2 pr-6 border-gray-300">
                {dummyData.projectCompletedCardPage.description}
                <div className="ml-4">
                  <ul className="flex flex-wrap gap-4">
                    <li className="min-w-[45%]">
                      ...
                      {dummyData.projectCompleteCard.email}
                    </li>
                    <li className="min-w-[45%]">
                      <span className="text-gray-700 font-semibold">
                        Status-{' '}
                    ...
                    <li className="min-w-[45%]">
                      ...
                      {dummyData.projectCompleteCard.start}
                    </li>
                    <li className="min-w-[45%]">
                      <span className="text-gray-700 font-semibold">
                        End Date-{' '}
                      </span>
                      {dummyData.projectCompleteCard.end}
                    </li>
                  </ul>
                </div>
              </div>
              <div>
                <div className="pt-4">
                  ...
                  <div className="flex flex-wrap gap-x-4 gap-y-2 my-4">
                    {dummyData.projectCompleteCard.skillsRequired.map(
                      (skill) => (
...
export default CompletedProjectDetailCard;
