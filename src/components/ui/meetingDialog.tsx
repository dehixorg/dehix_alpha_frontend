...
export function MeetingDialog({ isOpen, onClose }: MeetingDialogProps) {
  ...
  const [startDateTime, setStartDateTime] = useState<string>(dayjs().add(1, "day").format('YYYY-MM-DD'));
  const [endDateTime, setEndDateTime] = useState<string>(dayjs().add(1, "day").add(1, "hour").format('YYYY-MM-DD'));
